...
const figmaDesigns = [
  {
    id: 1,
    title: "KisanDost - UI/UX Case Study",
    description: "A comprehensive design system and high-fidelity prototype for an AI-powered agriculture platform, focusing on accessibility, rural user experience, and data visualization.",
